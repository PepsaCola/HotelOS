    ...
    return (
        <div className="flex flex-col justify-between gap-4 sm:flex-row sm:items-end">
            ...
            <div className="w-full sm:w-auto mt-1 sm:mt-0">
                <button className="inline-flex h-9 w-full sm:w-auto justify-center items-center gap-1.5 sm:gap-2 rounded-[9px] border border-hair-2 bg-white px-3.5 text-[12.5px] sm:text-[13.5px] font-medium text-ink-900 shadow-sm sm:shadow-none hover:bg-surface-soft transition-colors">
